...
export const creditcard = <i class="fa-regular fa-credit-card"></i>
export const debitcard = <i class="fa-solid fa-credit-card"></i>
export const bank = <i class="fa-solid fa-building-columns"></i>
export const upi = <i class="fa-solid fa-qrcode"></i>